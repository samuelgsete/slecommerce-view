...
import { ListarEnderecosUsuarioComponent } from './components/endereco-usuario/listar-enderecos-usuario/listar-enderecos-usuario.component';
...
const routes: Routes = [
  ...
  { path: 'loja', component: LayoutComponent, children: [
    ...
    { path: 'perfil', component: PerfilComponent, children: [
      { path: 'endereco', component: ListarEnderecosUsuarioComponent },
